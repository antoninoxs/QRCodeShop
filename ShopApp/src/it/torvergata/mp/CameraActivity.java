...
public class CameraActivity extends ListActivity {
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == 0) {
			if (resultCode == RESULT_OK) {
				...
				download_info_and_fills_product_list(contents);
	...
	public void download_info_and_fills_product_list(String productId){
		
		Product tempProd = new Product(Integer.parseInt(productId));
